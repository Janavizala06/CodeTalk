...
export const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center min-h-[calc(100vh-6rem)]">
      <h1
...
const ToolsDisplay = () => {
  return (
    <div className="w-full bg-transparent p-8 transition-colors duration-300">
      <h1 className="text-xl text-gray-800 dark:text-gray-200 text-center mb-5">
      ...
      <div className="justify-center mx-auto">
        <div className="flex flex-wrap justify-center gap-4">
          {/* Row 1 */}
          <div className="rounded-lg p-4 flex items-center gap-2 hover:bg-gray-200/80 dark:hover:bg-slate-700/50 transition-colors bg-transparent">
          ...
          <div className="rounded-lg p-4 flex items-center gap-2 hover:bg-gray-200/80 dark:hover:bg-slate-700/50 transition-colors bg-transparent">
            ...
            <span className="text-gray-800 dark:text-gray-200">Firebase</span>
          </div>

          <div className="rounded-lg p-4 flex items-center gap-2 hover:bg-gray-200/80 dark:hover:bg-slate-700/50 transition-colors bg-transparent">
            <img src={metalogo} alt="Meta Llama" className="h-6" />
            <span className="text-gray-800 dark:text-gray-200">Meta Llama</span>
          </div>
          ...
          <div className="rounded-lg p-4 flex items-center gap-2 hover:bg-gray-200/80 dark:hover:bg-slate-700/50 transition-colors bg-transparent">
            ...
            <span className="text-gray-800 dark:text-gray-200">Gemini</span>
          </div>
        </div>
      </div>
    </div>
